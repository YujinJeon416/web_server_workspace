...
/**
 * Servlet
 * sebservlet을 위한 java class
 * HttpServlet을 상속
 * 
 * Servlet 생명주기
 * -was구동 내내 딱 하나의 객체만 만들어져서 처리된다. (singletone방식)
 * 
 ...
 * 
 * 멱등 
 * - 서비스전후로 데이터베이스의 상태가 바뀌지 않는 경우
 * - select(멱등) -> GET
 * - insert update delete (멱등아님) -> POST
...
public class TestPerson1Servlet extends HttpServlet{
	...
	public TestPerson1Servlet() {
		super();
		System.out.println("기본생성자 TestPersonSErvlet() 호출!");
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		String[] foodArr = request.getParameterValues("food"); //복수개의 결과를 가져올때는 이걸쓴다.스트링배열로 가져옴
